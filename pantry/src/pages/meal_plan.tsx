...
const MealPlan: FunctionComponent<Props> = ({ recipeList, ingredientList }) => {
  ...
  let dietRestriction: Array<string> = [
    "Gluten Free",
    "Ketogenic",
    "Vegetarian",
    "Lacto-Vegetarian",
    ...
    >
      ...
      <div className="flexbox-container">
        <div>
          ...
          <Button
            onClick={() => addPlan2(bmname, lmname, dmname, "Monday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(btname, ltname, dtname, "Tuesday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(bwname, lwname, dwname, "Wednesday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(bhname, lhname, dhname, "Thursday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(bfname, lfname, dfname, "Friday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(bsname, lsname, dsname, "Saturday", id)}
          >
            Save
          </Button>
        </div>
        ...
        <div>
          ...
          <Button
            onClick={() => addPlan2(buname, luname, duname, "Sunday", id)}
          >
            Save
          </Button>
        </div>
